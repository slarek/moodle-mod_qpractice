...
$string['qpractice:addinstance'] = 'Add a qpractice instance';
$string['qpractice:attempt'] = 'Attempt a qpractice session';
$string['qpractice:view'] = 'View a qpractice session';
$string['qpractice:viewallreports'] = 'View all qpractice reports';
